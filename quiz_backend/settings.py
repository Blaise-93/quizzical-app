...
READ_DOT_ENV_DOC = env.bool('READ_DOT_ENV_DOC', default=False)
if READ_DOT_ENV_DOC:
...
# Pls check django-alluath for more configurations
ACCOUNT_AUTHENTICATION_LOGIN_REDIRECT = True

ACCOUNT_AUTHENTICATION_METHOD = 'username' # set it to false later

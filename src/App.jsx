    ...
    <div className="quiz__container">
      {!quizzical ? (
        <div className="start__container">
           <img src='./public/start1.png'  alt='quiz background logo' className='img__one' />
            <img src='./public/start2.png' alt='quiz background logo' className='img__two' />
        ...
        <div>
           <img src="./public/quiz1.png"  alt="quiz background logo" className="img__one" />
            <img src="./public/quiz2.png" alt='quiz background logo' className="img__two" />
